...
import 'package:flutter_tutorial/widgets/app_buttons.dart';
              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                      ...
                      children: [
                        Wrap(
                          children: List.generate(5, (index) {
                            return Icon(
                              Icons.star,
                              color: index < gottenStars ? AppColors.startColor : AppColors.textColor2,
                            );
                          }),
                        ),
                        SizedBox(
                    ...
                    AppText(
                      text: 'You must go for a travel. Travelling helps get rid of pressure. Go to the mountains to see the nature',
                      color: AppColors.mainTextColor,
                    )
                  ],
                ),
